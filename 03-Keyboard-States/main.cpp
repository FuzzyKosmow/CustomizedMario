...
#define ID_SPRITE_FIREBALL_1 30001
#define ID_SPRITE_FIREBALL_2 30002
...
void LoadResources()
{
	...
	//Fireball
	sprites->Add(ID_SPRITE_FIREBALL_1, 569, 120, 578, 128, texMisc);
	sprites->Add(ID_SPRITE_FIREBALL_2, 582, 119, 589, 128, texMisc);
	ani = new CAnimation(100);
	ani->Add(ID_SPRITE_FIREBALL_1);
	ani->Add(ID_SPRITE_FIREBALL_2);
