...
#define OVERWORLD_MARIO_TRAVEL_DISTANCE_BETWEEN_NODE 30.0f
#define OVERWORLD_MARIO_TRAVEL_SPEED 0.1f

#define OVERWORLD_MARIO_AX 0.1f
#define OVERWORLD_MARIO_AY 0.1f
